...
<script type="text/javascript" src="simpleTransition/jquery.cycle.all.js"></script>
...
<!-- fwtable fwsrc="Sem título" fwpage="Página 1" fwbase="menu-banner.png" fwstyle="Dreamweaver" fwdocid = "1163430818" fwnested="0" -->
  ...
  <tr>
   <td><a href="atividades_complementares.php" onmouseout="MM_swapImgRestore();" onmouseover="MM_swapImage('menubanner_r1_c1','','images/menu-banner_r1_c1_s2.png',1); muda_banner('banner_atividades.JPG');" id="img_menu"><img name="menubanner_r1_c1" src="images/menu-banner_r1_c1.png" width="239" height="97" id="menubanner_r1_c1" alt="" /></a></td>
  ...
  <tr>
   <td><a href="objetivos.php" onmouseout="MM_swapImgRestore();" onmouseover="MM_swapImage('menubanner_r3_c1','','images/menu-banner_r3_c1_s2.png',1); muda_banner('banner_missao.jpg');" id="img_menu"><img name="menubanner_r3_c1" src="images/menu-banner_r3_c1.png" width="239" height="95" id="menubanner_r3_c1" alt="" /></a></td>
   <td><img src="spacer.gif" width="1" height="95" alt="" /></td>
  </tr>
  <tr>
  ...
  <tr>
   <td><a href="contato.php" onmouseout="MM_swapImgRestore();" onmouseover="MM_swapImage('menubanner_r5_c1','','images/menu-banner_r5_c1_s2.png',1); muda_banner('banner_contato.jpg');" id="img_menu"><img name="menubanner_r5_c1" src="images/menu-banner_r5_c1.png" width="239" height="95" id="menubanner_r5_c1" alt="" /></a></td>
   <td><img src="spacer.gif" width="1" height="95" alt="" /></td>
  </tr>
  <tr>
   ...
   <td  width="1" height="299"></td>
      ...
      <div class="col_w900  col_w900_last">
    	 ...
    	 <div class="col_allw280 fp_service_box">
                <div><a href="escola.php"><img src="images/escola.jpg" width="280" height="357" /></a></div>
          
    	 </div>
      <div class="col_allw280 fp_service_box">
                <div><a href="cursos.php"><img src="images/cursos.png" width="280" height="357" /></a></div>
        ...
        <div id="destaque_01"  style="background-color:#FFF;">
         <div><img src="images/patrocinadores.png" /></div>
         <table width="435" border="0" cellspacing="0" cellpadding="10">
           <tr>
             <td align="center">
             
             <div class="slideshow" style="height:110px;"> 
...
<div style="background-color:#2D2F7A; height:40px;"></div>
        ...
        <div id="destaque_02"> <a href="trabalhe.php"><img src="images/trabalhe.png" width="435" height="208" /></a></div>
                <div class="cleaner h20"></div>
  </div>
</div> <!-- end of main -->
