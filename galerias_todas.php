...
$query_galeria = "SELECT * FROM galeria_g";
$galeria = mysql_query($query_galeria, $memorial2014) or die(mysql_error());
  ...
  <!-- end of middle -->
    ...
    <div id="templatemo_main">
      ...
      <div class="cleaner h30"> 
        <h3><strong>	&nbsp;GALERIAS</strong> DE FOTOS</h3>
    </div>
          <div>
...
?>
                   <td><table width="180" border="0" cellspacing="9" cellpadding="10">
                     <tr>
                       <td align="center"><a href="galerias_ver.php?gid=<?php echo $row_galeria['g_id']; ?>"><img src="images/galeria/<?php echo $row_galeria['g_imagem']; ?>" width="180" height="120"  style="border:1px solid #999" /><br />
                        <?php echo $row_galeria['g_descricao']; ?></a></td>
                     </tr>
                 </table></td>
                   <?php
$row_galeria = mysql_fetch_assoc($galeria);
    ...
    if (isset($row_galeria) && is_array($row_galeria) && $nested_galeria++ % 4==0) {
      echo "</tr><tr>";
    }
