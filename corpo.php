  ...
  <!-- end of middle -->
    ...
    <div id="templatemo_main">
      ...
      <div class="cleaner h30"> 
        <h3><strong>	&nbsp;Corpo docente</strong></h3>
    </div>
          <div>
          ...
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><span class="col_w900" style="background-color:#FFF;">Todos os nossos Professores têm formação superior, adequada ao exercício do Magistério, variando de graduação a doutorado.</span></td>
            </tr>
          </table>
<div class="cleaner"></div>
      </div>
